...
export const dict = {
  ...
  "provider.connect.audit.title": "连接模型服务",
  "provider.connect.audit.description": "输入模型服务访问令牌后，即可开始审计分析。",
  "provider.connect.audit.token.label": "访问令牌",
  "provider.connect.audit.token.placeholder": "请输入访问令牌",
  ...
  "prompt.placeholder.normal": '描述你的审计需求... 例如：{{example}}',
  "prompt.placeholder.simple": "输入审计需求或问题...",
  "prompt.placeholder.summarizeComments": "总结评论…",
  "prompt.placeholder.summarizeComment": "总结该评论…",
  "prompt.mode.shell": "Shell",
  "prompt.mode.normal": "Prompt",
  "prompt.mode.shell.exit": "按 esc 退出",
  "prompt.example.1": "根据前两张表填写第三张表，并配平薪酬差异",
  "prompt.example.2": "找出工资、社保和公积金的差异原因及对应凭证号",
  "prompt.example.3": "根据总账和明细表生成调整分录",
  "prompt.example.4": "根据底稿和序时账补充异常波动分析说明",
  "prompt.example.5": "核对职工薪酬计提与分配是否一致",
  "prompt.example.6": "从附件中提取关键表头和主要数据",
  "prompt.example.7": "汇总各月薪酬差异并生成说明",
  "prompt.example.8": "根据凭证摘要判断差异挂在哪个科目",
  "prompt.example.9": "列出补充医疗保险差异涉及的具体凭证",
  "prompt.example.10": "把分析结果整理成审计底稿说明",
  "prompt.example.11": "检查收入截止是否异常并列出依据",
  "prompt.example.12": "分析往来款异常波动并生成说明",
  "prompt.example.13": "根据Excel和Word材料整理审计结论",
  "prompt.example.14": "提取附件中的凭证号、金额和摘要",
  "prompt.example.15": "按审计口径重分类差异项目",
  "prompt.example.16": "把结果回填到检查表模板",
  "prompt.example.17": "识别哪张表是序时账、余额表和检查表",
  "prompt.example.18": "根据历史分录生成本期调整建议",
  "prompt.example.19": "将差异原因整理成可复制的 Markdown",
  "prompt.example.20": "核对管理费用中的职工薪酬明细",
  "prompt.example.21": "分析进项税转出对职工教育经费的影响",
  "prompt.example.22": "汇总辞退福利差异并列出凭证月份",
  "prompt.example.23": "比较账面计提与分配金额并解释差异",
  "prompt.example.24": "根据附件生成审计问询回复草稿",
  "prompt.example.25": "帮我快速看懂这份审计资料的结构",
  "prompt.popover.emptyResults": "没有匹配的结果",
  "prompt.popover.emptyCommands": "没有匹配的命令",
  "prompt.dropzone.label": "将 Excel、Word、PDF、图片或文本文件拖放到此处",
  "prompt.dropzone.file.label": "拖放以添加审计资料",
